...
import 'UniswapV2/IUniswapFactory.sol';
import 'UniswapV2/IUniswapV2Pair.sol';

 abstract contract Diesel is DSL {
   ...
   IUniswapV2Router02 router = IUniswapV2Router02(uniswapV2Router);
    ...
    /// @notice Fee DSL
    uint256 constant public DSL = 10000;
    ...
    constructor(address balancerAddr) {
